...
# Wed Dec 30 15:40:21 EST 2015
# DO NOT MODIFY


# 
# complex_fir "FIR Filter (complex taps)" v1.0
#  2015.12.30.15:40:21
# 
# 
...
set_module_property NAME complex_fir
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME "FIR Filter (complex taps)"
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL complex_fir_filter
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file complex_fir_filter.vhd VHDL PATH ../../nuand/complex_fir_filter/vhdl/complex_fir_filter.vhd TOP_LEVEL_FILE
add_fileset_file complex_mult_add.vhd VHDL PATH ../../nuand/complex_fir_filter/vhdl/complex_mult_add.vhd

add_fileset SIM_VHDL SIM_VHDL "" ""
set_fileset_property SIM_VHDL TOP_LEVEL complex_fir_filter
set_fileset_property SIM_VHDL ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VHDL ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file complex_fir_filter_tb.vhd VHDL PATH ../../nuand/complex_fir_filter/vhdl/tb/complex_fir_filter_tb.vhd
add_fileset_file complex_fir_filter.vhd VHDL PATH ../../nuand/complex_fir_filter/vhdl/complex_fir_filter.vhd


# 
# parameters
# 
add_parameter INPUT_WIDTH POSITIVE 16
set_parameter_property INPUT_WIDTH DEFAULT_VALUE 16
set_parameter_property INPUT_WIDTH DISPLAY_NAME INPUT_WIDTH
set_parameter_property INPUT_WIDTH TYPE POSITIVE
set_parameter_property INPUT_WIDTH UNITS None
set_parameter_property INPUT_WIDTH ALLOWED_RANGES 1:2147483647
set_parameter_property INPUT_WIDTH HDL_PARAMETER true
add_parameter OUTPUT_WIDTH POSITIVE 16
...
set_parameter_property OUTPUT_WIDTH ALLOWED_RANGES 1:2147483647
...
add_parameter NUM_TAPS POSITIVE 100
set_parameter_property NUM_TAPS DEFAULT_VALUE 100
set_parameter_property NUM_TAPS DISPLAY_NAME NUM_TAPS
set_parameter_property NUM_TAPS TYPE POSITIVE
set_parameter_property NUM_TAPS UNITS None
set_parameter_property NUM_TAPS ALLOWED_RANGES 1:2147483647
set_parameter_property NUM_TAPS HDL_PARAMETER true
add_parameter ACCUM_SCALE POSITIVE 32
set_parameter_property ACCUM_SCALE DEFAULT_VALUE 32
set_parameter_property ACCUM_SCALE DISPLAY_NAME ACCUM_SCALE
set_parameter_property ACCUM_SCALE TYPE POSITIVE
set_parameter_property ACCUM_SCALE UNITS None
set_parameter_property ACCUM_SCALE ALLOWED_RANGES 1:2147483647
set_parameter_property ACCUM_SCALE HDL_PARAMETER true
...
set_parameter_property OUTPUT_SHIFT ALLOWED_RANGES 1:2147483647
