...
architecture arch of rotator_tb is
...
begin
    ...
    begin
        ...
        -- Set dphase to 256 integer radians
        tmp(15 downto 0) := std_logic_vector(to_signed(-1228, 16));

        mm_write(clock, avs_config_address, avs_config_writedata, avs_config_write, to_unsigned(0, 8), unsigned(tmp)) ;

        -- Give the NCO time to settle
        nop(clock, 50);
